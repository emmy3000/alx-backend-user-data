#!/usr/bin/env python3
"""
This module filters logs by redacting sensitive information
and logs user data.
"""
...
def filter_datum(
    ...
    Args:
        ...
        redaction (str): The string to replace the sensitive data.
...
def main():
    """
    Logs user data from the database using the configured logger.
    """
...
class RedactingFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        """
        Formats a log record with sensitive data redacted.
